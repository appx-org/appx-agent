			...
			<div className="agent-chat-ext-actions">
				{request.method === "confirm" ? (
					<>
						<button
							type="button"
							className="agent-chat-btn-secondary"
							disabled={busy}
							onClick={() => void sendResponse({ confirmed: false })}
						>
							Deny
						</button>
						<button
							type="button"
							className="agent-chat-btn-primary"
							disabled={busy}
							onClick={() => void sendResponse({ confirmed: true })}
						>
							Approve
						</button>
					</>
					...
					<>
						<button
							...
							className="agent-chat-btn-secondary"
							disabled={busy}
							onClick={() => void sendResponse({ cancelled: true })}
						>
							Cancel
						</button>
						<button
							...
							className="agent-chat-btn-primary"
							disabled={busy}
							onClick={() => void sendResponse({ value })}
						>
