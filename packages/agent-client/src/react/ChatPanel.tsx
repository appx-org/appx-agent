...
export function ChatPanel({
	...
	const costRatesForModel = useMemo(() => resolveCostRates(costRates, activeModel), [costRates, activeModel]);
	const usage = useMemo(
		() =>
	...
	return (
		<div className={["agent-chat-chat-panel", classNames.chatPanel, className].filter(Boolean).join(" ")}>
			{showHeader && (
				<div className="agent-chat-header">
					...
					{showModelControls && (
						...
						<div className="agent-chat-model-controls" role="group" aria-label="Agent model settings">
			...
			{state.extensionNotice && (
				<div
					className={
						state.extensionNotice.type === "error" ? "agent-chat-error-banner" : "agent-chat-notice-banner"
					}
				>
